...
public class ViewTransactionActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // transactionsCursorAdapter = new TransactionsCursorAdapter(getBaseContext(),null);
        ...
        System.out.println("TRANSACTION FRAGMENT ONCREATE VIEW");
    ...
    @Override
    public void retrieveTransaction(TransactionsCursorAdapter adapter) {
        Cursor cursor = dbHelper.querryBorrowTransactionsJoinUser("0");
